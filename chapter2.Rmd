...
```{r}
test_error()
test_function("table",index=2, incorrect_msg = "Make sure you extract the variable region from the dataset.")
...
You can now close this window to go back to the [course](https://courses.edx.org/courses/course-v1:HarvardX+PH125.1x+2T2017/courseware/cfded5c208bc4e379606cb712cc54f25/5ba06674d0be41b99185b947e09e889b/?child=first).
