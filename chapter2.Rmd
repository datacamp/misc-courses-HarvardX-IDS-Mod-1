...
`@instructions`
For this question we will combine two functions to determine the number of unique categories.
Use the functions `levels` and `length` to determine the number of regions defined by this dataset. 
