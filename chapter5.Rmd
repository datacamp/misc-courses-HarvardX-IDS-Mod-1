...
`@instructions`
We are interested in specifying Celsius instead of Fahrenheit. Remember that to covert from Fahrenheit to Celsius we use $C = 5/9 \times (F-32)$.

- Use vector arithmentics to convert `temp` to Celsius
...
- Then compute the average murder rate for the US using the function `mean`. What is this average?
