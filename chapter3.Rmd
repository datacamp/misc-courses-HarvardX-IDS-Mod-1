...
`@instructions`
We will use the cities from the previous question (Beijing, Lagos, Paris, Rio de Janeiro, San Juan, and Toronto).
...
# Create a character vector to store the temperatures listed i into city
# Make sure to follow the same order as in the instructions
