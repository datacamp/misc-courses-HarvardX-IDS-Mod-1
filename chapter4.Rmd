...
`@instructions`
Define a variable `states` to hold the state names from the murders data frame. Find the index of the smallest state using `which.min(murders$population)]`. Then combine these to find the state name for the smallest state.
