...
Note that we car write `population` rather than `murders$population`. The function `mutate` knows we are grabing columns from `murders`.
...
# Redefine mutate to include a column named rank
