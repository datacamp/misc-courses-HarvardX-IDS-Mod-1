...
test_output_contains("5050", incorrect_msg = "That formula does not give the correct answer. Look at the example code.")
test_student_typed("n*(n+1)/2", not_typed_msg = "Make sure you type the equation. Look at the example code.")
...
- Make sure your code inclues the `log10` and `sqrt`functions.
