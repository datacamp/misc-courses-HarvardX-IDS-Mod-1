...
# Get the indeces of entries that are below 1
...
- In a previous exercise we computed the index `abbs%in%murders$abbs`. Use `which` and the `!` operator to get the index of the entries of `abbs` that are **not** abbreviations.
